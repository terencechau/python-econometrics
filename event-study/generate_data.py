...
missing_rate = 0.05  # Proportion of missing outcome data
...
treatment_time_simul = 5  # Everyone treated at the same time

# Treated only in post-treatment periods
panel_simul['treated'] = (
    panel_simul['ever_treated'] & (panel_simul['time'] >= treatment_time_simul)
).astype(int)
